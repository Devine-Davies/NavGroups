...
export class _Hooks {
    ...
    public _GatewayClient : any = null;
    ...
    */
    private invoke_client_hook( hook_name : string = null )
    {
        // console.log( this._GatewayClient.get_client_type() );
        // console.log( this._GatewayClient.get_cluster_code() );
